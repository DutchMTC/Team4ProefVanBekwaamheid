...
{
    [SerializeField] private float _speed = 0.01f; // Speed of zoom and pan
    [SerializeField] private float _minZoom = 0.1F; // Minimum zoom level
    [SerializeField] private float _maxZoom = 1F; // Maximum zoom level
    ...
    private void CameraZoom(float increment)
    {
        ...
        float zoomFactor = increment * _speed;
        _topCamera.orthographicSize = Mathf.Clamp(_topCamera.orthographicSize - zoomFactor, _minZoom, _maxZoom);
    }
}