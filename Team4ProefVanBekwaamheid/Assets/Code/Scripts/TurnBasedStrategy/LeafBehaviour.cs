...
public class LeafBehaviour : MonoBehaviour
{
    ...
    private IEnumerator FadeOutCoroutine(float duration)
    {
        ...
        {
            Debug.LogError("No MeshRenderers or materials found in children!");
            yield break;
        }
        ...
        Debug.Log($"Found {materials.Length} materials to fade");
        ...
        while (elapsedTime < duration)
        {
            ...
            Debug.Log($"Fading out: {(progress * 100):F0}% complete. Cutoff: {currentCutoff:F2}");
            yield return null;
        }
